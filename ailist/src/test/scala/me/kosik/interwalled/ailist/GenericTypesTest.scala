...
class GenericTypesTest extends AnyFunSuite with Matchers {
  ...
  test("String + String intervals") {
    val lhs = (1 to 1000) map { i => new Interval("CH1", i +    0, i +    0, i.toString)}
    val rhs = (1 to 1000) map { i => new Interval("CH1", i + 1003, i + 1003, i.toString)}
  ...
  test("String + Long intervals") {
    val lhs = (1 to 1000) map { i => new Interval("CH1", i +    0, i +    0, i.toString)}
    val rhs = (1 to 1000) map { i => new Interval("CH1", i + 1003, i + 1003, i.toLong)}
  ...
  test("String + Product intervals") {
    val lhs = (1 to 1000) map { i => new Interval("CH1", i +    0, i +    0, i.toString)}
    val rhs = (1 to 1000) map { i => new Interval("CH1", i + 1003, i + 1003, (i, i, i))}
  ...
  test("Data validation: 1 left interval matching all right intervals.") {
    val lhs = new Interval("CH1", 0, 10000, "L") :: Nil
    val rhs = (1 to 10000) map { i => new Interval("CH1", i, i, "R")}
